...
@section('title', 'Business Category List')
...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0">Business Category List</h1>
  </div>
    ...
    <div class="card-header user_list py-3">
      <div class="tab-content" id="myTabContent">
        ...
        <div class="row border-bottom mb-4 align-items-center">
            <div class="col-md-9">
              <h4 class="my-4 text-gray-600">Business Category List</h4>
            </div>
            <div class="col-md-3 text-right">
              <a href="{{route('admin.businessCategory.create')}}" class="add_btn">+ Add New</a>
            </div>
          </div>
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-bordered dataTable-table" id="businessCategory-table" width="100%" cellspacing="0">
                <thead>
                  <tr>
