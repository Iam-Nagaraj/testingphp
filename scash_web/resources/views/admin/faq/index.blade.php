    ...
    <div class="card-header user_list py-3">
      <div class="tab-content" id="myTabContent">
        ...
        <div class="row border-bottom mb-4 align-items-center">
            <div class="col-md-9">
              <h4 class="my-4 text-gray-600">Faq List</h4>
            </div>
            <div class="col-md-3 text-right">
              <a href="{{route('admin.faq.create')}}" class="add_btn">+ Add New</a>
            </div>
          </div>
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-bordered dataTable-table" id="faq-table" width="100%" cellspacing="0">
                <thead>
                  <tr>
