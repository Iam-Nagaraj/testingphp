        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form id="cashback-form" method="POST" action="{{route('admin.cashback.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
							<div class="form-group input-group-outline mt-3" id="imageInput1">
								<label for="business_category_id" class="form-label">Business Category</label>
								{!! Form::hidden('cashback_id', $detail->id) !!}
								{!! Form::select('business_category_id', $businessCategory->pluck('name', 'id'), $detail->business_category_id,['class' => 'form-control']) !!}
						...
						<div class="col-md-6">
							<div class="form-group input-group-outline mt-3" id="imageInput">
                                ...
                                {!! Form::input('number', 'percentage', $detail->percentage, ['class' => 'form-control', 'step' => '0.01']) !!}
