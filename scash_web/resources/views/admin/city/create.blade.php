...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0">City Create</h1>
        <!-- <a
                href="#"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group input-group-outline mt-3" id="imageInput">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" name="name" type="text" value="">
                        ...
                        <div class="col-md-6">
                            <div class="form-group input-group-outline mt-3" id="imageInput">
                                ...
                                {!! Form::select('state_id', $stateModel, null, ['class' => 'form-control']) !!}
                        ...
                        <div class="col-md-6">
                            <div class="form-group input-group-outline mt-3" id="imageInput">
                                ...
                                <input class="form-control @error('latitude') is-invalid @enderror" name="latitude" type="text" value="">
                        ...
                        <div class="col-md-6">
                            <div class="form-group input-group-outline mt-3" id="imageInput">
                                ...
                                <input class="form-control @error('longitude') is-invalid @enderror" name="longitude" type="text" value="">
