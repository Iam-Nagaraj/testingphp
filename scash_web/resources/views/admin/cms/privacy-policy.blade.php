...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-600">Privacy Policy / <span class="text-dark">Cms</span></h1>
	</div>

	<!-- Content Row -->
	<div class="card video_tab shadow mb-4">
		<div class="card-header user_list py-3">
			<h3 class="mt-3 mb-3">Privacy Policy</h3>
			<form id="privacy-policy-form" method="POST" action="{{route('admin.cms.privacy-policy.save')}}">
				@csrf
