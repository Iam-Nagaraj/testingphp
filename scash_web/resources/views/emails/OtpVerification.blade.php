...
<body>
    ...
    <table style="background-color:#ffffff;border:0;border-collapse:collapse;border-spacing:0;box-sizing:inherit;font:inherit;font-family:Whitney-SSm-A,Whitney-SSm-B,Whitney,Helvetica Neue,Helvetica,Arial,sans-serif;font-size:100%;font-weight:300;line-height:100%;margin:0;padding:0;text-align:center;vertical-align:baseline;width:100%">
        <tbody>
            <tr>
                <td>
                                                                                        ...
                                                                                        <div style="color:#555555;line-height:120%;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif">
                                                                                            <div style="font-size:14px;line-height:15px;color:#555555;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif">
                                                                                                ...
                                                                                                <p style="margin:0 0 10px 0;font-size:15px;line-height:20px">
                                                                                                    Thanks for signing up! <br> Please enter the following verification code to access your Account.
                                                                                                </p>
                                                                                                <h2>{{$details['code']}}</h2> 
                                                                                                <p style="margin:0 0 10px 0;font-size:15px;line-height:20px">This verification code will only valid for the next 1 hour.</p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
