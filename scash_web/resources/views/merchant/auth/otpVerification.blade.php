  ...
  <div class="authentication-wrapper authentication-basic container-p-y">
    <div class="authentication-inner py-2">
      ...
      <div class="card p-2">
        ...
        <h4 class="mb-2">Welcome to Scash!</h4>
          <p class="mb-4">Please Verify Phone Number Using OTP</p>

          <form id="otp-verification-form" class="mb-3" action="{{route('merchant.auth.verifyOtp')}}" method="POST">
          @csrf
            <div class="form-floating form-floating-outline mb-3">
              <label for="email">Phone Number</label>
              <input type="number" class="form-control"  name="email_phone_number" placeholder="Enter your number" autofocus>
            ...
            <div class="mb-3">
              <button class="btn btn-primary d-grid w-100 verify_btn" type="submit">Verify Otp</button>
            </div>
          </form>
