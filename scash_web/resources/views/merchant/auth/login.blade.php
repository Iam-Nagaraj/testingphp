    ...
    <div class="authentication-inner py-4">
      ...
      <div class="card p-2">
        ...
        <div class="card-body mt-2">
          ...
          <form id="login-form" class="mb-3" action="{{route('merchant.auth.login.store')}}" method="POST">
          @csrf
            ...
            <div class="mb-3 d-flex justify-content-between">
              ...
              <a href="{{route('merchant.auth.forgotPassword')}}" class="float-end mb-1">
          ...
          <p class="text-center">
            ...
            <a href="{{route('merchant.auth.otp-verification')}}">
              <span>Verify</span>
            </a>
          </p>
        </div>
