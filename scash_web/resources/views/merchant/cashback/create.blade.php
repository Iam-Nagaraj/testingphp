...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0">Cash Back Create</h1>
            <!-- <a
                href="#"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group input-group-outline mt-3" id="imageInput">
                                ...
                                <input class="form-control" name="cashback" type="number" value="">
                        ...
                        <div class="col-md-6">
                            <div class="form-group input-group-outline mt-3" id="imageInput">
                                ...
                                <input class="form-control" name="min_amount" type="number" value="">
                        ...
                        <div class="col-md-6">
                            <div class="form-group input-group-outline mt-3" id="imageInput">
                                ...
                                <input class="form-control" name="max_amount" type="text" value="" >
