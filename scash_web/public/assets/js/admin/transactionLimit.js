$(document).on('submit', '#transactionLimit-form', function (e) {
	e.preventDefault();
	let myForm = document.getElementById('transactionLimit-form');
	let target = "transactionLimit-body";
...
async function AjaxFromLoginSubmit(formData, url, method, target) {
	...
	$.ajax({
		...
		success: async function (response) {
			...
			navigateTo('/configuration/transaction-limit');
