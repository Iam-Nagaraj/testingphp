...
$(document).on('submit', '#platformFee-form', function (e) {
	e.preventDefault();
	let myForm = document.getElementById('platformFee-form');
	let target = "platformFee-body";
...
async function AjaxFromLoginSubmit(formData, url, method, target) {
	...
	$.ajax({
		...
		success: async function (response) {
			...
			navigateTo('/configuration/platform-fee');
