$(document).on('submit', '#supportEmail-form', function (e) {
	e.preventDefault();
	let myForm = document.getElementById('supportEmail-form');
	let target = "supportEmail-body";
...
async function AjaxFromLoginSubmit(formData, url, method, target) {
	...
	$.ajax({
		...
		success: async function (response) {
			...
			navigateTo('/configuration/support-email');
