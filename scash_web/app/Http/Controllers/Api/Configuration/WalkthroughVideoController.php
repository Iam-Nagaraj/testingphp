...
use App\Http\Resources\ConfigurationWalkthroughVideoResource;
...
class WalkthroughVideoController extends Controller
{
	...
	/**
     * @OA\Get(
     ** path="/api/v1/configuration/walkthrough-video",
     *   tags={"configuration"},
     *   summary="Only for test",
     *   operationId="walkthrough-video",
     *   @OA\Response(
     *      response=201,
     *       description="Success",
     *      @OA\MediaType(
    ...
    **/
	public function index()
	{
		try {
			...
			return $this->sendResponse(new ConfigurationWalkthroughVideoResource($detail), 'Walkthrough Video fetched successfully.');
		} catch (Exception $ex) {
